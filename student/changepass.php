    ...
    if ($credentials->changePassword($_POST)) {
      echo "<script>
        $(document).ready(function(){
          ...
          $('.modal-body').text('Successfuly changed password');
                                ...
                                <div class="card-body">
                                  ...
                                  <form method="post" style="width:250px;">
                                    <div class="form-group">
                                      ...
                                      <input class="form-control form-control-sm" type="password" name="current_password" value="" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input class="form-control form-control-sm" type="password" name="confirm_password" value="" required>
                                    </div>
                                    <div class="form-group">
                                      <input class="btn btn-success"type="submit" name="change_password" value="Save Changes">
                                    </div>
                                  </form>
