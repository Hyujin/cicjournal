                                              ...
                                              <div class='dropdown no-arrow'style='float:right;' >
                                                  ...
                                                  <div class='dropdown-menu dropdown-menu-right shadow animated--fade-in'
                                                      ...
                                                      if ($obj['user_type'] != 'SUPER') {
                                                        echo "<input class='dropdown-item' type='submit' name='delete_post' value='Delete' style='color:rgb(219, 49, 44);'>";
                                                      }
                                                      echo "
                                                      <div class='dropdown-divider'></div>
...
<?php
  if (isset($_SESSION['to_delete'])) {
    require '../modal.php';
    $check_to_delete = $user->getSpecificUser($_SESSION['to_delete'])['id_number'];

    if (!empty($check_to_delete)) {
      if ($user->deleteUser($_SESSION['to_delete'])) {
        ...
        echo "<script>
          $(document).ready(function(){
            ...
            $('.modal-body').text('Successfully deleted user');
      ...
      echo "<script>
        $(document).ready(function(){
          ...
          $('.modal-title').text('CICjournal');
          $('.modal-body').text('Unable to fetch this user id');
          $('#modal-success-save').text('Cancel');
          $('#modal-success-close').text('Delete');
          $('#modal-success-save').hide();
          $('#modal-success-close').hide();
