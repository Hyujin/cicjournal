<?php
  ...
  if (!isset($_GET['view_type'])) {
    header("location: studentsettings.php?view_type=course");
  }else{
                                          ...
                                          <td style="width:100px;">
                                            <div class='dropdown no-arrow'style='float:right;' >
                                                ...
                                                <div class='dropdown-menu dropdown-menu-right shadow animated--fade-in'
                                                  ...
                                                  <a class='dropdown-item' name='delete_item' href="studentsettings.php?view_type=<?php echo strtolower($header_index)."&delete_id=".$value[$index."id"]; ?>" style='color:rgb(219, 49, 44);'> Delete </a>
...
<?php
  if (isset($_POST['add_item'])) {
    ...
    if ($setting->addItem($_POST)) {
      echo "<script>
        $(document).ready(function(){
          ...
          $('.modal-body').text('Successfully added ".strtolower($header_index)."');
    ...
    if ($setting->editItemName($_POST)) {
      echo "<script>
        $(document).ready(function(){
          ...
          $('.modal-title').text('CICjournal');
          $('.modal-body').text('Successfully edited ".strtolower($header_index)."');
          $('#modal-success-save').text('Cancel');
          $('#modal-success-close').text('Delete');
          $('#modal-success-save').hide();
          $('#modal-success-close').hide();
    ...
    array_pop($_POST);
    $redirect = "studentsettings.php?view_type=".strtolower($header_index);
    $to_delete_item = $setting->getItemInfo(strtolower($header_index),$_GET['delete_id']);
    var_dump($to_delete_item);

    if (!empty($to_delete_item)) {
      $_SESSION['to_delete'] = $_GET['delete_id'];
      ...
      echo "<script>
        $(document).ready(function(){
          ...
          $('.modal-title').text('CICjournal');
          $('.modal-body').text('Are you sure you want to delete this item?');
          $('#modal-success-save').text('Cancel');
          $('#modal-success-close').text('Delete');
          // $('#modal-success-save').hide();
          // $('#modal-success-close').hide();
          ...
          $('#modal-success-close').on('click', function(event){
            window.location.href = 'deleteitem.php?view_type=".strtolower($header_index)."';
          });
      ...
      echo "<script>
              window.location.href = 'studentsettings.php';
            </script>";
    }
