<?php
  ...
  $force_update_dashboard = new UserDashboard($_SESSION['email'],$_SESSION['user_type']);
  if(!isset($_SESSION['email']) || $_SESSION['user_type'] != "FACULTY"){
    header("location: ../");
  }else{
    if ($force_update_dashboard->isRegisterComplete()) {
      header("location: ../index.php");
    }
  }

  if (isset($_POST['finish_registration'])) {
    if (!$force_update_dashboard->completeRegistration($_POST)) {
      echo $force_update_dashboard->getError();
    }else{
      $force_update_dashboard = new UserDashboard($_SESSION['email'],$_SESSION['user_type']);
      if ($force_update_dashboard->isRegisterComplete()) {
        header("location: ../index.php");
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-5">Finish up your registration</h1>
                                        </div>
                                        <form class="user" method="post">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="" placeholder="Middle Name" name="middle_name">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="text"class="form-control" name="dob" placeholder="Birth date" onfocus="this.type='date'" onblur="this.type = 'text'">
                                            </div>
                                            <br>

                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-5">Faculty Information</h1>
                                            </div>

                                            <div align="center">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="" placeholder="Faculty ID (xxxx-xxxxx)"name="id_number">
                                            </div>
                                            <input type="hidden" name="reg_status" value="COMPLETE">
                                            <div class="form-group">
                                              <select id="inputState" class="form-control" name="employee_lvl">
                                                <option disabled selected hidden>Employee Level</option>
                                            ...
                                            <div class="form-group">
                                              <input type="submit" class="btn btn-primary btn-block" name="finish_registration" value="Submit">
                                            </div>
                                        </form>
                                    </div>
                                </div>
